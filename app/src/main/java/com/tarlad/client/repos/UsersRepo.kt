...
interface UsersRepo {
    ...
    fun searchUsersForChat(q: String, chatId: Long, userId: Long, page: Int): Observable<List<User>>
    fun getAllUsersFromChat(chatId: Long, userId: Long): Observable<List<User>>
